...
def default_detection_model_configs():
    ...
    # model name.
    h.name = 'tf_efficientdet_d4'

    h.backbone_name = 'tf_efficientnet_b4'
    ...
    #[(0.7, 1.4), (1.0, 1.0), (1.2, 0.8), (1.6, 0.6), (2.3, 0.4)]
#

#d7[(0.7, 1.4), (1.0, 1.0), (1.2, 0.8), (1.6, 0.6), (2.3, 0.4)]

#idnt know [(0.6, 1.6), (0.8, 1.2), (1.0, 1.0), (1.2, 0.8), (1.5, 0.7), (1.9, 0.5), (2.5, 0.4)]

#d3 new [(0.6, 1.7), (0.8, 1.3), (0.9, 1.1), (1.1, 0.9), (1.2, 0.8), (1.4, 0.7), (1.6, 0.6), (2.0, 0.5), (2.6, 0.4)]

#d333 [(0.6, 1.7), (0.8, 1.3), (0.9, 1.1), (1.0, 1.0), (1.2, 0.9), (1.3, 0.8), (1.5, 0.7), (1.7, 0.6), (2.1, 0.5), (2.6, 0.4)]

#d22 [(0.6, 1.7), (0.8, 1.3), (0.9, 1.1), (1.1, 0.9), (1.2, 0.8), (1.4, 0.7), (1.6, 0.6), (2.0, 0.5), (2.6, 0.4)]


#d1 [(0.6, 1.6), (0.8, 1.2), (1.0, 1.0), (1.2, 0.8), (1.5, 0.7), (1.9, 0.5), (2.5, 0.4)]


###[(0.7, 1.4), (1.0, 1.0), (1.2, 0.8), (1.6, 0.6), (2.3, 0.4)]
#36 [(0.6, 1.7), (0.8, 1.3), (0.9, 1.1), (1.0, 1.0), (1.2, 0.9)]
#[(0.7, 1.4), (1.0, 1.0), (1.2, 0.8), (1.6, 0.6), (2.3, 0.4)]
    #d40 [(1.0, 1.0), (1.2, 0.9), (1.3, 0.8), (1.5, 0.7), (1.7, 0.6)]

# d10   (1.6, 0.6), (1.9, 0.5), (2.2, 0.5), (2.5, 0.4), (2.9, 0.3)#[(0.7, 1.4), (1.0, 1.0), (1.2, 0.8), (1.6, 0.6), (2.3, 0.4)]#[(1.0, 1.0), (1.4, 0.7), (0.7, 1.4)]
    h.anchor_scale = 3.0
	#[(0.5, 1.9), (0.6, 1.6), (0.7, 1.4), (0.8, 1.2), (0.9, 1.1), (1.1, 0.9), (1.3, 0.8)] D00
    # FPN and head config
...
efficientdet_model_param_dict = dict(
    ...
    tf_efficientdet_d0=dict(
        ...
        fpn_cell_repeats=3,
        box_class_repeats=3,
        aspect_ratios = [(0.6, 1.6), (0.8, 1.2), (1.0, 1.0), (1.2, 0.8), (1.5, 0.7), (1.9, 0.5), (2.5, 0.4)],
        backbone_args=dict(drop_path_rate=0.2),
    ...
    tf_efficientdet_d2=dict(
        ...
        fpn_cell_repeats=5,
        box_class_repeats=3,
        aspect_ratios = [(0.6, 1.7), (0.8, 1.3), (0.9, 1.1), (1.1, 0.9), (1.2, 0.8), (1.4, 0.7), (1.6, 0.6), (2.0, 0.5), (2.6, 0.4)],
        backbone_args=dict(drop_path_rate=0.2),
    ...
    tf_efficientdet_d3=dict(
        ...
        fpn_cell_repeats=6,
        box_class_repeats=4,
        aspect_ratios = [(0.6, 1.7), (0.8, 1.3), (0.9, 1.1), (1.0, 1.0), (1.2, 0.9), (1.3, 0.8), (1.5, 0.7), (1.7, 0.6), (2.1, 0.5), (2.6, 0.4)],
        backbone_args=dict(drop_path_rate=0.2),
    ...
    tf_efficientdet_d4=dict(
        ...
        box_class_repeats=4,
        anchor_scale = 5.0,
        aspect_ratios = [(0.7, 1.4), (1.0, 1.0), (1.2, 0.8), (1.6, 0.6), (2.3, 0.4)],
        backbone_args=dict(drop_path_rate=0.2),
